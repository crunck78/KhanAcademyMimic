...
template <typename T>
void Input<T>::setValues(const std::vector<T> values, const bool checkTrue, const char *badInputMessage)
{
	_values.clear();
	_values = values;
...
template <typename T>
void Input<T>::setRange(const T lowest, const T highest, const char *badInputMessage)
{
	_values.clear();
	_values.push_back(lowest);
	_values.push_back(highest);
...
template <typename T>
T Input<T>::getInput(const char *messageToUser, const char *exceptionInputMessage)
{
...
template <typename T>
std::vector<T> Input<T>::getInputs(const T &exit, const char *messageToUser)
{
	std::vector<T> inputs;
...
template <typename T>
std::vector<T> Input<T>::getInputs(const unsigned int stop, const char *messageToUser)
{
	std::vector<T> inputs;
